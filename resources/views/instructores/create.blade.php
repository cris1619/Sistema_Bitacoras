        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            <div>
                ...
                <p class="text-muted mb-0">
                    Complete la información personal y asigne los programas correspondientes.
                </p>
            </div>
                ...
                <div class="tab-pane fade show active" id="personal" role="tabpanel">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="documento_identidad" class="form-control @error('documento_identidad') is-invalid @enderror" value="{{ old('documento_identidad') }}" maxlength="20" placeholder="Ej: 1098765432" required>
                        </div>

                        <div class="col-md-3 mb-3">
                            <label>Nombres <span class="text-danger">*</span></label>
                            <input type="text" name="nombres" class="form-control @error('nombres') is-invalid @enderror" value="{{ old('nombres') }}" maxlength="100" placeholder="Ingrese nombres" required>
                        </div>

                        <div class="col-md-3 mb-3">
                            <label>Apellidos <span class="text-danger">*</span></label>
                            <input type="text" name="apellidos" class="form-control @error('apellidos') is-invalid @enderror" value="{{ old('apellidos') }}" maxlength="100" placeholder="Ingrese apellidos" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="correo_electronico" class="form-control border-start-0 @error('correo_electronico') is-invalid @enderror" value="{{ old('correo_electronico') }}" placeholder="instructor@sena.edu.co" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="telefono" class="form-control border-start-0 @error('telefono') is-invalid @enderror" value="{{ old('telefono') }}" maxlength="20" placeholder="Ej: 3001234567">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <small class="text-muted mt-1 d-block">
                                <i class="fas fa-info-circle me-1"></i> Puede seleccionar varios programas haciendo clic sobre las opciones.
                            </small>
                        </div>
                    </div>
